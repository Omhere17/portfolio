            ...
            <div className="space-y-8 pt-12">
              ...
              <div className="space-y-4 max-w-6xl">
                ...
                <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-4">
                  ...
                  <div className="flex flex-col items-center justify-center gap-3 p-6 rounded-lg bg-gray-100 dark:bg-gray-800/50 hover:bg-gray-200 dark:hover:bg-gray-700/50 transition-all duration-300 group cursor-pointer">
                    <div className="w-12 h-12 flex items-center justify-center">
                      <img src={figmaLogo} alt="Figma" className="w-full h-full object-contain transition-all duration-300" style={{ filter: 'grayscale(100%) brightness(0.7)' }} onMouseEnter={(e) => e.currentTarget.style.filter = 'none'} onMouseLeave={(e) => e.currentTarget.style.filter = 'grayscale(100%) brightness(0.7)'} />
                    </div>
                  ...
                  <div className="flex flex-col items-center justify-center gap-3 p-6 rounded-lg bg-gray-100 dark:bg-gray-800/50 hover:bg-gray-200 dark:hover:bg-gray-700/50 transition-all duration-300 group cursor-pointer">
                    <div className="w-12 h-12 flex items-center justify-center">
                      <img src={illustratorLogo} alt="Adobe Illustrator" className="w-full h-full object-contain transition-all duration-300" style={{ filter: 'grayscale(100%) brightness(0.7)' }} onMouseEnter={(e) => e.currentTarget.style.filter = 'none'} onMouseLeave={(e) => e.currentTarget.style.filter = 'grayscale(100%) brightness(0.7)'} />
                    </div>
                  ...
                  <div className="flex flex-col items-center justify-center gap-3 p-6 rounded-lg bg-gray-100 dark:bg-gray-800/50 hover:bg-gray-200 dark:hover:bg-gray-700/50 transition-all duration-300 group cursor-pointer">
                    <div className="w-12 h-12 flex items-center justify-center">
                      <img src={photoshopLogo} alt="Adobe Photoshop" className="w-full h-full object-contain transition-all duration-300" style={{ filter: 'grayscale(100%) brightness(0.7)' }} onMouseEnter={(e) => e.currentTarget.style.filter = 'none'} onMouseLeave={(e) => e.currentTarget.style.filter = 'grayscale(100%) brightness(0.7)'} />
                    </div>
                  ...
                  <div className="flex flex-col items-center justify-center gap-3 p-6 rounded-lg bg-gray-100 dark:bg-gray-800/50 hover:bg-gray-200 dark:hover:bg-gray-700/50 transition-all duration-300 group cursor-pointer">
                    <div className="w-12 h-12 flex items-center justify-center">
                      <img src={notionLogo} alt="Notion" className="w-full h-full object-contain transition-all duration-300" style={{ filter: 'grayscale(100%) brightness(0.7)' }} onMouseEnter={(e) => e.currentTarget.style.filter = 'none'} onMouseLeave={(e) => e.currentTarget.style.filter = 'grayscale(100%) brightness(0.7)'} />
                    </div>
                  ...
                  <div className="flex flex-col items-center justify-center gap-3 p-6 rounded-lg bg-gray-100 dark:bg-gray-800/50 hover:bg-gray-200 dark:hover:bg-gray-700/50 transition-all duration-300 group cursor-pointer">
                    <div className="w-12 h-12 flex items-center justify-center">
                      <img src={tableauLogo} alt="Tableau" className="w-full h-full object-contain transition-all duration-300" style={{ filter: 'grayscale(100%) brightness(0.7)' }} onMouseEnter={(e) => e.currentTarget.style.filter = 'none'} onMouseLeave={(e) => e.currentTarget.style.filter = 'grayscale(100%) brightness(0.7)'} />
                    </div>
                  ...
                  <div className="flex flex-col items-center justify-center gap-3 p-6 rounded-lg bg-gray-100 dark:bg-gray-800/50 hover:bg-gray-200 dark:hover:bg-gray-700/50 transition-all duration-300 group cursor-pointer">
                    <div className="w-12 h-12 flex items-center justify-center">
                      <img src={unityLogo} alt="Unity" className="w-full h-full object-contain transition-all duration-300" style={{ filter: 'grayscale(100%) brightness(0.7)' }} onMouseEnter={(e) => e.currentTarget.style.filter = 'none'} onMouseLeave={(e) => e.currentTarget.style.filter = 'grayscale(100%) brightness(0.7)'} />
                    </div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div className="flex flex-col items-center justify-center gap-3 p-6 rounded-lg bg-gray-100 dark:bg-gray-800/50 hover:bg-gray-200 dark:hover:bg-gray-700/50 transition-all duration-300 group cursor-pointer">
                    <div className="w-12 h-12 flex items-center justify-center">
                      <img src={premiereLogo} alt="Adobe Premiere Pro" className="w-full h-full object-contain transition-all duration-300" style={{ filter: 'grayscale(100%) brightness(0.7)' }} onMouseEnter={(e) => e.currentTarget.style.filter = 'none'} onMouseLeave={(e) => e.currentTarget.style.filter = 'grayscale(100%) brightness(0.7)'} />
                    </div>
                  ...
                  <div className="flex flex-col items-center justify-center gap-3 p-6 rounded-lg bg-gray-100 dark:bg-gray-800/50 hover:bg-gray-200 dark:hover:bg-gray-700/50 transition-all duration-300 group cursor-pointer">
                    <div className="w-12 h-12 flex items-center justify-center">
                      <img src={afterEffectsLogo} alt="Adobe After Effects" className="w-full h-full object-contain transition-all duration-300" style={{ filter: 'grayscale(100%) brightness(0.7)' }} onMouseEnter={(e) => e.currentTarget.style.filter = 'none'} onMouseLeave={(e) => e.currentTarget.style.filter = 'grayscale(100%) brightness(0.7)'} />
                    </div>
                  ...
                  <div className="flex flex-col items-center justify-center gap-3 p-6 rounded-lg bg-gray-100 dark:bg-gray-800/50 hover:bg-gray-200 dark:hover:bg-gray-700/50 transition-all duration-300 group cursor-pointer">
                    <div className="w-12 h-12 flex items-center justify-center">
                      <img src={indesignLogo} alt="Adobe InDesign" className="w-full h-full object-contain transition-all duration-300" style={{ filter: 'grayscale(100%) brightness(0.7)' }} onMouseEnter={(e) => e.currentTarget.style.filter = 'none'} onMouseLeave={(e) => e.currentTarget.style.filter = 'grayscale(100%) brightness(0.7)'} />
                    </div>
