        ...
        <div className="max-w-6xl mx-auto">
          <div className="space-y-12">
            ...
            <div className="flex justify-center items-center py-8 w-full">
              <div className="flex items-center justify-between w-full max-w-6xl -space-x-12 md:-space-x-10 lg:-space-x-20 xl:-space-x-24">
                <div className="relative w-[180px] h-[180px] md:w-[200px] md:h-[200px] lg:w-[260px] lg:h-[260px] xl:w-[300px] xl:h-[300px] rounded-full overflow-hidden group cursor-pointer transition-transform duration-500 hover:z-10 hover:scale-110">
            ...
            {/* Story Content */}
            <div className="space-y-6 text-base md:text-base lg:text-lg leading-relaxed text-foreground/90">
            ...
            <div className="space-y-6 pt-12">
              <h2 className="text-2xl md:text-3xl font-bold text-primary lg:text-4xl">
                Education
              </h2>
            ...
            {/* Experience Section */}
            <div className="space-y-6 pt-12">
              <h2 className="text-2xl md:text-3xl font-bold text-primary lg:text-4xl">Work Experience</h2>
