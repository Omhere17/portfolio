  ...
  return <section className="pt-8 pb-16 overflow-hidden">
      <div className="container mx-auto px-16 lg:px-24 py-16">
        ...
        <div className="relative flex items-center overflow-hidden">
          {/* Left fade */}
          <div className="absolute left-0 top-0 bottom-0 w-64 lg:w-80 bg-gradient-to-r from-background via-background/90 to-transparent z-10 pointer-events-none" />
          ...
          {/* Right fade */}
          <div className="absolute right-0 top-0 bottom-0 w-64 lg:w-80 bg-gradient-to-l from-background via-background/90 to-transparent z-10 pointer-events-none" />
        </div>
      </div>
    </section>;
};